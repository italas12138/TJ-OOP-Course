...
ostream& operator<<(ostream& os, Book_Sale& bk) {
    cout << "该书的ISBN号为:" << bk.isbn;
    cout << "，销量为:" << bk.sales_volume << "本";
    cout << "，原价为:" << bk.original_price << "元";
    cout << "，折扣为:" << bk.discount;
    cout << "，现价为:" << bk.real_price << "元";
    cout << "，总销售额为:" << bk.gross_sales << "元";
    cout << endl;
    return os;
}
...
{
    {
        ...
        cout << "b1应该是该书的ISBN号为:978-7-121-95995-0，销量为:3418本，原价为:100元，折扣为:0.9，现价为:90元，总销售额为:311800元，折扣限制数量为:3000本\n实际为：";
        b1.display();
        cout << "b2应该是同上，实际为：";
        b2.display();
        cout << "b3应该是同上，实际为：";
        ...
        Book_Sale_Limit b4;
        cout << "请输入某书籍销售信息：" << endl; //95995 3418 100 0.9 3000
        cin >> b4;
...

    {
        ...
        cout << "b1应该是该书的ISBN号为:978-7-121-95995-0，销量为:3418本，原价为:100元，折扣为:0.9，现价为:90元，总销售额为:311800元，折扣限制数量为:3000本\n实际为：";
        b1.display();
        cout << "b2应该是该书的ISBN号为:978-7-121-95995-0，销量为:3418本，原价为:100元，折扣为:1，现价为:100元，总销售额为:341800元，折扣限制数量为:3000本\n实际为：";
        b2.display();
        cout << "b3应该是该书的ISBN号为:978-7-121-95995-0，销量为:3500本，原价为:100元，折扣为:0.8，现价为:80元，总销售额为:290000元，折扣限制数量为:3000本\n实际为：";
        b3.display();
...

    {
        ...
        b1 += 10;
        cout << "b1应该是该书的ISBN号为:978-7-121-95995-0，销量为:3428本，原价为:100元，折扣为:0.9，现价为:90元，总销售额为:312800元，折扣限制数量为:3000本\n实际为：";
        b1.display();
